...
MODULES = (
    ...
    "ordering_live_quote", "ordering_account", "ordering_live_catalog", "ordering_live_selection", "ordering_packages", "ordering_live_api",
)
